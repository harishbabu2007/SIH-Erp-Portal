      ...
      <div className="grid gap-6 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Progress value={typeof occupancyRate === 'number' && !isNaN(occupancyRate) ? occupancyRate : 0} className="mt-2" />
          </CardContent>
        </Card>
      </div>
          ...
          <Card key={room.id} className="relative">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <Progress value={room.capacity > 0 ? (room.occupied / room.capacity) * 100 : 0} className="h-2" />
              </div>
            </CardContent>
          </Card>
        ))}
          ...
          <CardContent>
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-2">
                  {studentData.room.students.filter(s => s !== 'John Doe').length > 0 ? (
                    <div className="space-y-2">
                      {studentData.room.students.filter(s => s !== 'John Doe').map((student, index) => (
